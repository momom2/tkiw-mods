...
impl Feature for DumpLibraries {
    ...
    fn summary(&self) -> &'static str {
        "Diagnostic: writes the game's own content libraries (units, improvements, \
         upgrades, artifacts, spells) to a JSON file, once, then switches itself off. \
         Used to build reference data; changes nothing about the game."
    }
